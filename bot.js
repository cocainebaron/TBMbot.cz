 ...
 (function () {
    ...
    var subChat = function (chat, obj) {
        if (typeof chat === "undefined") {
            API.chatLog("Chybí text zprávy.");
            console.log("Chybí text zprávy.");
            return "[Error] Nebyla nalezena zpráva v jazykovém balíčku.";
        }
        var lit = '%%';
        for (var prop in obj) {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Tessi1998/TBMbot.cz/master/langpack.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "TBMbot",
        loggedInID: null,
        scriptLink: "https://googledrive.com/host/0By7K1cTbnJlzdHZReVdmS0VZQjA",
        cmdLink: "http://bit.ly/TBMcommands",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            botName: "TBMbot",
            language: "czech",
            chatLink: "https://rawgit.com/Tessi1998/TBMbot.cz/master/cz.json",
            ...
            historySkip: true,
            timeGuard: true,
            maximumSongLength: 08.00,
            autodisable: false,
            commandCooldown: 0.0000000000000000000000000001,
            usercommandsEnabled: true,
            lockskipPosition: 1,
            lockskipReasons: [
                ["theme", "Tenhle song není vhodný pro naši roomku. "],
                ["op", "Tenhle song je na OP seznamu. "],
                ["history", "Tenhle song je v historii. "],
                ["mix", "Tenhle song je v rozporu s našimi pravidly. "],
                ["sound", "Tenhle song má buď špatnou kvalitu, nebo to není song. "],
                ["nsfw", "Tenhle song je NSFW (obraz nebo zvuk). "],
                ["unavailable", "Tenhle song nebyl dostupný pro všechny uživatele. "]
            ],
            afkpositionCheck: 15,
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me " + lastplay.dj + ": " + lastplay.score.positive + "W/" + lastplay.score.grabs + "G/" + lastplay.score.negative + "M")
                }
                else {
                    API.sendChat(subChat(basicBot.chat.songstatistics, {lastplay.dj woots: lastplay.score.positive, grabs: lastplay.score.grabs, mehs: lastplay.score.negative}))
                }
            }
        ...
        commands: {
            executable: function (minRank, chat) {
                ...
                switch (minRank) {
                    ...
                    case 'user':
                        ...
                        break;
                    default:
                        API.chatLog('error musíš být aspoň vyhazovač');
                }
                return perm >= minPerm;
            ...
            cookieCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['ti daroval/a čokoládovou sušenku.',
                    ...
                    'ti daroval/a duhovou sušenku, která je pečena s láskou. :heart:',
			...
			helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "http://bit.ly/TBMcommands";
			...
			opCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.opLink === "http://bit.ly/1C1sdss")
            ...
            rulesCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.roomrules)
                    }
                }
    		},
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me Bota vytvořil ' + botCreator + ' a nyní ho upravuje ' + botMaintainer + ".");
                    }
                }
            },
